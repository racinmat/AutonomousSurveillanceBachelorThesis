...
namespace App
{
	...
	std::vector<std::shared_ptr<Map>> MapFactory::createMaps(int uavCount)
	{
		...
		{
			map0->addUavStart(make_shared<PointParticle>(50 + i * uavDistance, 50, 0, 0));
		}
		...
		for (int i = 0; i < uavCount; i++)
		{
			map1->addUavStart(make_shared<PointParticle>(401 + i * uavDistance, 501, 0, 0));
		}
		...
		for (int i = 0; i < uavCount; i++)
		{
			map2->addUavStart(make_shared<PointParticle>(50 + i * uavDistance, 50, 0, 0));
		}
		...
		for (int i = 0; i < uavCount; i++)
		{
			map3->addUavStart(make_shared<PointParticle>(50 + i * uavDistance, 50, 0, 0));
		}
		...
		for (int i = 0; i < uavCount; i++)
		{
			map4->addUavStart(make_shared<PointParticle>(380 + i * uavDistance, 50, 0, 0));
		}
		...
		for (int i = 0; i < uavCount; i++)
		{
			map5->addUavStart(make_shared<PointParticle>(400 + i * uavDistance, 50, 0, 0));
		}
		...
		for (int i = 0; i < uavCount; i++)
		{
			map6->addUavStart(make_shared<PointParticle>(400 + i * uavDistance, 50, 0, 0));
		}
