...
//		}
		...
		vector<unordered_map<Uav, shared_ptr<Point>, UavHasher>> inputs = generator.generateNTuplet<shared_ptr<Point>>(oneUavInputs, near_node->uavs, uavCount - 1);	//poèet všech kombinací je poèet všech monıch vstupù jednoho UAV ^ poèet UAV
