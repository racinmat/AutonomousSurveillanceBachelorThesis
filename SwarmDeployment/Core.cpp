...
//		}
		...
		auto inputs = generator.generateNTuplet(oneUavInputs, near_node->uavs, uavCount - 1);	//poèet všech kombinací je poèet všech monıch vstupù jednoho UAV ^ poèet UAV
