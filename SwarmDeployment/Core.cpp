...
//		}
		...
		auto inputs = inputGenerator->generateAllInputs(distance_of_new_nodes, max_turn, near_node->getUavs());		//poèet všech kombinací je poèet všech monıch vstupù jednoho UAV ^ poèet UAV
