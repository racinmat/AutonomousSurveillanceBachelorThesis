...
namespace App
{
	...
	bool CollisionDetector::checkRelativeLocalization(shared_ptr<StateInterface> node)	//todo: zjistit, zda funguje spr�vn�, pokud je nastaven 1 soused a vypnut swarm splitting
	{
		...
		//TODO: zkontrolovat, zda jsou UAV celistv�m �et�zem, pomoc� DFS nebo BFS prohledat cel� graf (graf sestav�m z adjacency matrix tak, �e 1 je tam, kde jsou UAV ve spr�vn� vzd�lenosti a jinde je 0)
...
//		}
	...
	{
		//TODO: zamyslet se, jestli neslou�it tuto metodu a checkObstaclesInTrajectories do jedn�, proto�e �e�en� koliz� trv� neskute�n� dlouho
